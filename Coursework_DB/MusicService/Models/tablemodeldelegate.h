...
private:
    QVariant extra_id; //used only in addTrackDelegate and MyTrackDelegate to add or delete track
...
public:
    ...
    void setExtra_id(const QVariant &value);//used only in addTrackDelegate
...
signals:
    ...
    void del_from_playlist(QVariant , QVariant );
    void del_playlist(QVariant id);
    void choose_playlist(QVariant id, QVariant track_id);
};
