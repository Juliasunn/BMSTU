...
void SQLiteQueryCreator::convert(std::string &query_text,
...
std::string SQLiteQueryCreator::createSelectQuery(Table tableName,
                          ...
                          std::vector<QueryParam> params, Column sort_raw)
{
    ...
    qDebug() << "SQLiteQueryCreator::createSelectQuery "<<query_text.c_str();
    return query_text ;
}

std::string SQLiteQueryCreator::createCountQuery(Table tableName, std::vector<QueryParam> params)
{
...
std::string SQLiteQueryCreator::createUpdateQuery(Table tableName,
            std::vector<QueryParam> vals, std::vector<QueryParam> conds)
{
    ...
    qDebug() << "SQLiteQueryCreator::createUpdateQuery "<<query_text.c_str();
    return query_text;
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

std::string SQLiteQueryCreator::createDeleteQuery(Table tableName, std::vector<QueryParam> conds)
{
    std::string query_text = "delete from " + DBTables[tableName];

    query_text += " where ";
    convert(query_text, "and", conds);
    qDebug() << "SQLiteQueryCreator::createDeleteQuery "<<query_text.c_str();
    return query_text;
}

std::string SQLiteQueryCreator::createJoinQuery(std::vector<Table> tableName,
                                                 ...
                                                 std::vector<QueryParam> params)
{
   ...
   qDebug() << "SQLiteQueryCreator::createJoinQuery "<<query_text.c_str();
    return query_text ;
}

std::string SQLiteQueryCreator::createJoin(std::vector<Table> tableName, std::vector<Column> join_columns)
{
...
std::string SQLiteQueryCreator::createInsertQuery(Table tableName,
                                 std::vector<QueryParam> params)
{
    int n = params.size();
   ...
   qDebug() << "SQLiteQueryCreator::createInsertQuery "<<query_text.c_str();
   return query_text;
}
